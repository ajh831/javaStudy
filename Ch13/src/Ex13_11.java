class Ex13_11 {
	...
	public static void main(String args[]) {
		ThreadEx13_11_1 th1 = new ThreadEx13_11_1();
		ThreadEx13_11_2 th2 = new ThreadEx13_11_2();
		th1.start();
		th2.start();
...
class ThreadEx13_11_1 extends Thread {
	public void run() {
		for (int i = 0; i < 300; i++) {
...
class ThreadEx13_11_2 extends Thread {
	public void run() {
		for (int i = 0; i < 300; i++) {
			System.out.print(new String("|"));
		}
