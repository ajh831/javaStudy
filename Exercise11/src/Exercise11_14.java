// Scanner클래스를 이용해서 화면으로 부터 데이터를 입력하고 보여주는 기능을 완성하시오.
...
class Exercise11_14 {
	...
	static void inputRecord() {
		...
		while (true) {
			 ...
			 * 입력받은 값이 q또는 Q이면 메서드를 종료하고, 그렇지 않으면 입력받은 값으로 Student인스턴스를 생성하고 record에 추가한다.
			 * 3. 입력받은 데이터에서 예외가 발생하면 "입력오류입니다."를 보여주고 다시 입력받는다. 4. q또는 Q가 입력될 때까지 2~3의 작업을
			 * 반복한다.
			 */
